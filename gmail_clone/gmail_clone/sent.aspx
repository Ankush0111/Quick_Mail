<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sent.aspx.cs" Inherits="gmail_clone.sent" %>
        ...
        <td>
            ...
            <td>
                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="send.png" 
                    Height="50px" Width="60px" OnClick="ImageButton2_Click1" /><br />
         ...
         <asp:TemplateField HeaderText="Title">
            <ItemTemplate>
                <asp:HyperLink ID="TitleLink" runat="server" Text='<%# Eval("title") %>'
                    NavigateUrl='<%# "sent-content.aspx?title=" + Server.UrlEncode(Eval("title").ToString()) %>' />
            </ItemTemplate>
        </asp:TemplateField>
 ...
 <!-- <div id="layerc1" runat="server"></div>
   <div id="outerc1" runat="server">
    <div id="Div1" runat="server">
       <a id="ImageButton5" href="sent.aspx"><img alt="cancel" height="20px" width="20px" /></a>
    </div>
