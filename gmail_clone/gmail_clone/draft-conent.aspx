<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="draft-conent.aspx.cs" Inherits="gmail_clone.draft_conent" %>
...
<div>
    ...
    <asp:TextBox ID="txtDate" runat="server" CssClass="xb1" ReadOnly="true"></asp:TextBox>
                ...
                <h2>Attachment URL:<asp:Button ID="btnSend" runat="server" Text="Send" CssClass="auto-style1"  Width="132px"  />
            </h2>
