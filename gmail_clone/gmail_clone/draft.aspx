<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="draft.aspx.cs" Inherits="gmail_clone.draft" %>
    ...
    <div id="next1">
         ...
         <table cellpadding="5" cellspacing="5">
            ...
            <tr>
                ...
                <td valign="middle">
                    ...
                    <asp:Label ID="Label2" runat="server" CssClass="xb1" Text="Lebel"></asp:Label>
        ...
        <td>
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="inbox.png" 
                Height="50px" Width="60px" OnClick="ImageButton1_Click1" /><br />
            &nbsp;&nbsp;
...
<asp:Label ID="Label10" runat="server" Text="Settings"></asp:Label>
    ...
    <%-- <div id="x">
         ...
         <asp:GridView ID="GridView1" runat="server" Width="90%" margin-left="auto" margin-right="auto"
            CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="grid" AutoGenerateColumns="false" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
         ...
         <asp:TemplateField HeaderText="Title">
            <ItemTemplate>
                <asp:HyperLink ID="TitleLink" runat="server" Text='<%# Eval("title") %>'
                    NavigateUrl='<%# "draft-conent.aspx?title=" + Server.UrlEncode(Eval("title").ToString()) %>' />
            </ItemTemplate>
        </asp:TemplateField>
        <asp:BoundField DataField="dt" HeaderText="Date" />
    </Columns>
  ...
  <!--<div id="layerc1" runat="server"></div>
   <div id="outerc1" runat="server">
    <div id="Div1" runat="server">
       <a id="ImageButton5" href="Draft.aspx"><img alt="cancel" height="20px" width="20px" /></a>
    </div>
...
<asp:Label ID="Label7" runat="server" Text="Label"></asp:Label><br /><br />Title:&nbsp;&nbsp;&nbsp;
       ...
       &nbsp; <asp:TextBox ID="TextBox5" runat="server" ReadOnly="true" 
            TextMode="MultiLine" Width="250px" Height="150px" 
          ></asp:TextBox><br /><br />
        <asp:HyperLink ID="HyperLink1" runat="server">Attachments</asp:HyperLink>
